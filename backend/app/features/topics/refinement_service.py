...
get_all_topics_with_words = _repository.get_all_topics_with_words
get_all_topics = _repository.get_all_topics
get_topic_by_id_with_words = _repository.get_topic_by_id_with_words
