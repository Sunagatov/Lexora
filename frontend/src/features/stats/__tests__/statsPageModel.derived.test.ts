...
function makeStats(): StatsResponse {
  return {
    ...
    vocab_profile: {
      cefr_distribution: {B1: 40, B2: 50, C1: 30},
      register_distribution: {neutral: 80, formal: 20, informal: 20},
      pos_distribution: {noun: 50, verb: 40, adjective: 30},
    },
    enrichment_coverage: {
      total_words: 120,
      with_definition: 110,
