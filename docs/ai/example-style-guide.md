# Lexora example style guide

Use this when generating examples for vocabulary enrichment.
...
- Prefer model-written examples over deterministic template fillers.
- If existing examples are already strong and varied, leave them alone.

## Quality checks

- No sentence should feel formulaic or copied from a template.
- Avoid repetitive subjects, repeated openers, and repeated verbs unless the word itself requires it.
- If an existing set of examples is already strong, keep it unless it violates one of the rules above.
